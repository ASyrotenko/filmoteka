 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(){this._=void 0}}function Pe(t,e,n){return t instanceof Fe?Be(t,e):t instanceof Ve?je(t,e):n}function Me(t,e){var n,r;return t instanceof qe?St(n=e)||(r=n)&&"doubleValue"in r?e:{integerValue:0}:null}class Ue extends xe{}class Fe extends xe{constructor(t){super(),this.elements=t}}function Be(t,e){const n=ze(e);for(const e of t.elements)n.some((t=>wt(t,e)))||n.push(e);return{arrayValue:{values:n}}}class Ve extends xe{constructor(t){super(),this.elements=t}}function je(t,e){let n=ze(e);for(const e of t.elements)n=n.filter((t=>!wt(t,e)));return{arrayValue:{values:n}}}class qe extends xe{constructor(t,e){super(),this.yt=t,this.gt=e}}function $e(t){return dt(t.integerValue||t.doubleValue)}function ze(t){return At(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=index.77aee4d7.js.map
