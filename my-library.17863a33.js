 ...
 * limitations under the License.
 */
(0,s("ix4Jr").registerVersion)("firebase","9.15.0","app")})),s.register("ftYLF",(function(t,n){e(t.exports,"getFirestore",(function(){return s("3PjDZ").getFirestore})),e(t.exports,"doc",(function(){return s("3PjDZ").doc})),e(t.exports,"setDoc",(function(){return s("3PjDZ").setDoc})),e(t.exports,"getDoc",(function(){return s("3PjDZ").getDoc})),e(t.exports,"updateDoc",(function(){return s("3PjDZ").updateDoc})),e(t.exports,"deleteField",(function(){return s("3PjDZ").deleteField})),s("3PjDZ")})),s.register("3PjDZ",(function(t,n){e(t.exports,"doc",(function(){return Fi})),e(t.exports,"getFirestore",(function(){return Yi})),e(t.exports,"getDoc",(function(){return Oo})),e(t.exports,"setDoc",(function(){return xo})),e(t.exports,"updateDoc",(function(){return Po})),e(t.exports,"deleteField",(function(){return Fo}));var r=s("ix4Jr"),i=s("4a6xH"),o=s("7vF8m"),a=s("ffjl9"),c=s("lW9Fu");s("4TNnu");const u="@firebase/firestore";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ro=/^__.*__$/;class so{toMutation(e,t){return null!==this.fieldMask?new tn(e,this.data,this.fieldMask,t,this.fieldTransforms):new en(e,this.data,t,this.fieldTransforms)}constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}}class io{toMutation(e,t){return new tn(e,this.data,this.fieldMask,t,this.fieldTransforms)}constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}}function oo(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw v()}}class ao{get path(){return this.settings.path}get sa(){return this.settings.sa}ia(e){return new ao(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.yt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ra(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ia({path:n,oa:!1});return r.ua(e),r}ca(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ia({path:n,oa:!1});return r.na(),r}aa(e){return this.ia({path:void 0,oa:!0})}ha(e){return To(e,this.settings.methodName,this.settings.la||!1,this.path,this.settings.fa)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}na(){if(this.path)for(let e=0;e<this.path.length;e++)this.ua(this.path.get(e))}ua(e){if(0===e.length)throw this.ha("Document fields must not be empty");if(oo(this.sa)&&ro.test(e))throw this.ha('Document fields cannot begin and end with "__"')}constructor(e,t,n,r,s,i){this.settings=e,this.databaseId=t,this.yt=n,this.ignoreUndefinedProperties=r,void 0===s&&this.na(),this.fieldTransforms=s||[],this.fieldMask=i||[]}}class co{da(e,t,n,r=!1){return new ao({sa:e,methodName:t,fa:n,path:q.emptyPath(),oa:!1,la:r},this.databaseId,this.yt,this.ignoreUndefinedProperties)}constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.yt=n||is(e)}}function uo(e){const t=e._freezeSettings(),n=is(e._databaseId);return new co(e._databaseId,!!t.ignoreUndefinedProperties,n)}function lo(e,t,n,r,s,i={}){const o=e.da(i.merge||i.mergeFields?2:0,t,n,s);vo("Data must be an object, but it was:",o,r);const a=mo(r,o);let c,u;if(i.merge)c=new it(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const e=[];for(const r of i.mergeFields){const s=wo(t,r,n);if(!o.contains(s))throw new T(b.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);Io(e,s)||e.push(s)}c=new it(e),u=o.fieldTransforms.filter((e=>c.covers(e.field)))}else c=null,u=o.fieldTransforms;return new so(new ot(a),c,u)}class ho extends to{_toFieldTransform(e){if(2!==e.sa)throw 1===e.sa?e.ha(`${this._methodName}() can only appear at the top level of your update data`):e.ha(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ho}}function fo(e,t,n,r){const s=e.da(1,t,n);vo("Data must be an object, but it was:",s,r);const i=[],o=ot.empty();re(r,((e,r)=>{const c=bo(t,e,n);r=(0,a.getModularInstance)(r);const u=s.ca(c);if(r instanceof ho)i.push(c);else{const e=go(r,u);null!=e&&(i.push(c),o.set(c,e))}}));const c=new it(i);return new io(o,c,s.fieldTransforms)}function po(e,t,n,r,s,i){const o=e.da(1,t,n),c=[wo(t,r,n)],u=[s];if(i.length%2!=0)throw new T(b.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<i.length;e+=2)c.push(wo(t,i[e])),u.push(i[e+1]);const l=[],h=ot.empty();for(let e=c.length-1;e>=0;--e)if(!Io(l,c[e])){const t=c[e];let n=u[e];n=(0,a.getModularInstance)(n);const r=o.ca(t);if(n instanceof ho)l.push(t);else{const e=go(n,r);null!=e&&(l.push(t),h.set(t,e))}}const d=new it(l);return new io(h,d,o.fieldTransforms)}function go(e,t){if(yo(e=(0,a.getModularInstance)(e)))return vo("Unsupported field value:",t,e),mo(e,t);if(e instanceof to)return function(e,t){if(!oo(t.sa))throw t.ha(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.ha(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.oa&&4!==t.sa)throw t.ha("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const s of e){let e=go(s,t.aa(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=(0,a.getModularInstance)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return Lt(t.yt,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=M.fromDate(e);return{timestampValue:jn(t.yt,n)}}if(e instanceof M){const n=new M(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:jn(t.yt,n)}}if(e instanceof no)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof Zi)return{bytesValue:qn(t.yt,e._byteString)};if(e instanceof Pi){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.ha(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Kn(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ha(`Unsupported field value: ${Ni(e)}`)}(e,t)}function mo(e,t){const n={};return se(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):re(e,((e,r)=>{const s=go(r,t.ra(e));null!=s&&(n[e]=s)})),{mapValue:{fields:n}}}function yo(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof M||e instanceof no||e instanceof Zi||e instanceof Pi||e instanceof to)}function vo(e,t,n){if(!yo(n)||("object"!=typeof(r=n)||null===r||Object.getPrototypeOf(r)!==Object.prototype&&null!==Object.getPrototypeOf(r))){const r=Ni(n);throw"an object"===r?t.ha(e+" a custom object"):t.ha(e+" "+r)}var r}function wo(e,t,n){if((t=(0,a.getModularInstance)(t))instanceof eo)return t._internalPath;if("string"==typeof t)return bo(e,t);throw To("Field path arguments must be of type string or ",e,!1,void 0,n)}const Eo=new RegExp("[~\\*/\\[\\]]");function bo(e,t,n){if(t.search(Eo)>=0)throw To(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new eo(...t.split("."))._internalPath}catch(r){throw To(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function To(e,t,n,r,s){const i=r&&!r.isEmpty(),o=void 0!==s;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${r}`),o&&(c+=` in document ${s}`),c+=")"),new T(b.INVALID_ARGUMENT,a+e+c)}function Io(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{get id(){return this._key.path.lastSegment()}get ref(){return new Pi(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new So(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Co("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}constructor(e,t,n,r,s){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=s}}class So extends _o{data(){return super.data()}}function Co(e,t){return"string"==typeof t?bo(e,t):t instanceof eo?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Do{isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}}class No extends _o{exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Ro(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(Co("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}constructor(e,t,n,r,s,i){super(e,t,n,r,i),this._firestore=e,this._firestoreImpl=e,this.metadata=s}}class Ro extends No{data(e={}){return super.data(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Oo(e){e=Ri(e,Pi);const t=Ri(e.firestore,Qi);return Gi(Xi(t),e._key).then((n=>Uo(t,e,n)))}class Lo extends ko{convertBytes(e){return new Zi(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Pi(this.firestore,null,t)}constructor(e){super(),this.firestore=e}}function xo(e,t,n){e=Ri(e,Pi);const r=Ri(e.firestore,Qi),s=Ao(e.converter,t,n);return Mo(r,[lo(uo(r),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,$t.none())])}function Po(e,t,n,...r){e=Ri(e,Pi);const s=Ri(e.firestore,Qi),i=uo(s);let o;return o="string"==typeof(t=(0,a.getModularInstance)(t))||t instanceof eo?po(i,"updateDoc",e._key,t,n,r):fo(i,"updateDoc",e._key,t),Mo(s,[o.toMutation(e._key,$t.exists(!0))])}function Mo(e,t){return function(e,t){const n=new I;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const r=Si(e);try{const e=await function(e,t){const n=E(e),r=M.now(),s=t.reduce(((e,t)=>e.add(t.key)),_n());let i,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=gn(),c=_n();return n.Gi.getEntries(e,s).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(c=c.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((s=>{i=s;const o=[];for(const e of t){const t=Jt(e,i.get(e.key).overlayedDocument);null!=t&&o.push(new tn(e.key,t,at(t.value.mapValue),$t.exists(!0)))}return n.mutationQueue.addMutationBatch(e,r,o,t)})).next((t=>{o=t;const r=t.applyToLocalDocumentSet(i,c);return n.documentOverlayCache.saveOverlays(e,t.batchId,r)}))})).then((()=>({batchId:o.batchId,changes:vn(i)})))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.hc[e.currentUser.toKey()];r||(r=new et(x)),r=r.insert(t,n),e.hc[e.currentUser.toKey()]=r}(r,e.batchId,n),await bi(r,e.changes),await As(r.remoteStore)}catch(e){const t=Bs(e,"Failed to persist write");n.reject(t)}}(await zi(e),t,n))),n.promise}(Xi(e),t)}function Uo(e,t,n){const r=n.docs.get(t._key),s=new Lo(e);return new No(e,s,t._key,r,new Do(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
